        ...
        <Reveal y={20}>
          <div>
            ...
            <p className="mt-5 max-w-md text-sm leading-relaxed text-fg-muted">
              RUINED exists for researchers who expect more from a supplier.
              We hold every batch to a strict internal purity and identity
              standard, ship fast, and package discreetly — no shortcuts, no
              filler, no vague sourcing.
            </p>
